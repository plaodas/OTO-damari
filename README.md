...
| --- | --- | --- |
| 弱い | ソルフェジオ共鳴音 | ふわっと光る |
| 中くらい | ソルフェジオ共鳴音 | 流れ始め、水面が光る |
| 強い | ソルフェジオ共鳴音 | 高速で流れて光の帯になる |
| タップ | ソルフェジオ共鳴音 | 周囲の粒子が弾ける |
| 左下の丸 | カメラ | 撮った像の暗い部分ほど粒子が密に集まり、被写体が点描として浮かぶ |
| 傾ける | — | 低い方向へゆっくり漂う |
| 北を向く | — | 粒が上へ流れ始める（地磁気） |

- 吹く強さが一段上がった瞬間に共鳴音が鳴ります
- マイクを拒否すると吹きかけ検出だけが無効になり、粒子表示とタップ操作は継続します
- タップ、スワイプ、シェイク、吹き、撮影、北向きへの進入では、174〜963 Hzの9音が控えめな共鳴音として順番に巡ります。音響演出であり、医療・治癒効果を意図したものではありません
...
- 端末が北を向くと、吹いていないあいだ粒が画面の上へ流れます。方位はコンパス（地磁気）で、最初の画面タップ後に有効になります。PCや HTTP（localhost 以外）では反応しません。Android の Brave など、シールドでセンサーを止めるブラウザでは Chrome より効きにくいことがあります
